				...
				<div id="browser-settings-section" style={{ marginBottom: 20 }}>
					...
					<div style={{ marginBottom: isSubSettingsOpen ? 0 : 10 }}>
						...
						<p
							...
							{t("browser.disableToolUsage.description")}
						</p>
					</div>
					...
					<CollapsibleContent isOpen={isSubSettingsOpen}>
						<div style={{ marginBottom: 15 }}>
							...
							<p
								...
								{t("browser.viewport.description")}
							</p>
						</div>
						...
						<div style={{ marginBottom: 0 }}>
									...
									{shouldShowRelaunchButton && (
										<div style={{ display: "flex", gap: "10px", marginBottom: 8, justifyContent: "center" }}>
											<VSCodeButton
												...
												style={{ flex: 1 }}>
												{debugMode ? t("browser.launchingBrowser") : t("browser.launchDebugMode")}
											</VSCodeButton>
										</div>
									)}
							...
							<div style={{ marginBottom: 8, marginTop: 8 }}>
								...
								<p
									...
									{t("browser.chromePath.autoDetect")}
								</p>
							</div>
							...
							<div style={{ marginBottom: 8, marginTop: 8 }}>
								...
								<p
									...
									{t("browser.customArgs.description")}
								</p>
							</div>
						</div>
					</CollapsibleContent>

			...
			<div
				...
				<div className="flex items-center gap-2">
					<VSCodeCheckbox
						...
						<span className="text-sm">{t("autoApprove.notifications.label")}</span>
					</VSCodeCheckbox>
				</div>
				<div className="mt-1 text-xs text-muted-foreground">{t("autoApprove.notifications.description")}</div>
			</div>
		</div>
	)
}

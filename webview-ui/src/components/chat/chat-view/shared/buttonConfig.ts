...
export const BUTTON_CONFIGS: Record<string, ButtonConfig> = {
	...
	api_req_failed: {
		...
		enableButtons: true,
		primaryText: "buttons.retry",
		secondaryText: "buttons.startNewTask",
		primaryAction: "retry",
	...
	mistake_limit_reached: {
		...
		enableButtons: true,
		primaryText: "buttons.proceedAnyways",
		secondaryText: "buttons.startNewTask",
	...
	tool_approve: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "buttons.approve",
		secondaryText: "buttons.reject",
	...
	command: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "buttons.runCommand",
		secondaryText: "buttons.reject",
		primaryAction: "approve",
		secondaryAction: "reject",
	},
	command_output: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "buttons.proceedWhileRunning",
	...
	completion_result: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "buttons.startNewTask",
		secondaryText: undefined,
	...
	resume_task: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "buttons.resumeTask",
		secondaryText: undefined,
		primaryAction: "proceed",
		secondaryAction: undefined,
	},
	...
	new_task: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "buttons.startNewTaskWithContext",
		secondaryText: undefined,
		primaryAction: "new_task",
		secondaryAction: undefined,
	},
	...
	condense: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "buttons.condenseConversation",
		secondaryText: undefined,
	...
	report_bug: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "buttons.reportGitHubIssue",
		secondaryText: undefined,
		primaryAction: "utility",
		secondaryAction: undefined,
	},
